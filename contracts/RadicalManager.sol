...
contract RadicalManager is IERC721Receiver {
    ...
    constructor() public {
        ...
        registrar = BaseRegistrar(0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85);
    ...
    function onERC721Received(
        ...
        // Authorise sender to use ENS domain
        registrar.reclaim(tokenId, from);
    ...
    function depositRent(uint256 tokenId) public payable onlyLeaseholderOrContract(tokenId) {
        ...
        emit RentDeposited(msg.sender, tokenId, msg.value);
    }
